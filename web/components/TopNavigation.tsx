            ...
            <div className={`hidden md:flex flex-1 items-center ${isSpecialPage ? 'justify-end' : 'justify-between'} ml-8`}>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {isLoggedIn && pathname === '/privatehome' && (
                    <Link href="/vault" className={`px-5 py-2 rounded-full font-semibold transition-transform duration-300 hover:scale-105 ${useDarkText ? 'bg-black text-white hover:bg-gray-800 dark:bg-gray-700' : 'bg-white text-black hover:bg-gray-200'}`}>
                      Vault
                    </Link>
                  )}
                  ...
                  {isLoggedIn ? (
                    pathname !== '/privatehome' && (
                      <Link href="/privatehome" className={`px-5 py-2 rounded-full font-semibold transition-transform duration-300 hover:scale-105 ${useDarkText ? 'bg-black text-white hover:bg-gray-800 dark:bg-gray-700' : 'bg-white text-black hover:bg-gray-200'}`}>
                        Private Home
                      </Link>
                    )
                  ) : (
          ...
          >
            <div className="flex h-full flex-col items-center justify-center space-y-6 pt-24 pb-8 px-4 overflow-y-auto">
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                {isLoggedIn && pathname === '/privatehome' && (
                  <Link href="/vault" onClick={() => setIsMenuOpen(false)} className="px-5 py-2 rounded-full font-semibold transition-transform duration-300 hover:scale-105 bg-black text-white hover:bg-gray-800 dark:bg-gray-700">
                    Vault
                  </Link>
                )}
                ...
                {isLoggedIn ? (
                  pathname !== '/privatehome' && (
                    <Link href="/privatehome" onClick={() => setIsMenuOpen(false)} className="px-5 py-2 rounded-full font-semibold transition-transform duration-300 hover:scale-105 bg-black text-white hover:bg-gray-800 dark:bg-gray-700">
                      Private Home
                    </Link>
                  )
                ) : (

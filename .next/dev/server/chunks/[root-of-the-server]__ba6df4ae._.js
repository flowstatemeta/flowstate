...
"[project]/web/sanity.client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
;
const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$index$2e$browser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])({
    projectId,
    dataset,
    apiVersion,
    useCdn: false,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$sanity$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/sanity.client.ts [app-route] (ecmascript)");
...
async function rotateUserSession(userId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$sanity$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].patch(userId).set({
        sessionToken: newToken
    }).commit();
    return newToken;
}
async function validateUserSession(userId, sessionToken) {
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$sanity$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].fetch(`*[_type == "user" && _id == $userId][0]{ sessionToken }`, {
        userId
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$sanity$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/sanity.client.ts [app-route] (ecmascript)"); // Adjust path as needed
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials, req) {
                ...
                const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$sanity$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].fetch(__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$groq$2f$lib$2f$groq$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__groq$3e$__["groq"]`*[_type == "user" && username == $username][0]{..., "hashedPassword": hashedPassword}`, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba6df4ae._.js.map